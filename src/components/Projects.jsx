            ...
            <div className="flex flex-col flex-wrap md:flex-row lg:flex-row gap-5 m-5 lg:[70%]">
                ...
                <motion.div whileInView={{ opacity: 1, x: 0 }}
                    ...
                    <div className="project flex flex-col justify-center gap-5 m-auto my-5 w-[80%]">
                        ...
                        <div className="flex justify-center ">
                            <img src="/blog-hive.jpg" alt="project1" className='w-[200px] lg:w-[300px]' />
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div whileInView={{ opacity: 1, x: 0 }}
                    ...
                    <div className="project flex flex-col justify-center gap-5 m-auto my-5 w-[80%]">
                        ...
                        <div className="flex justify-center">
                            <img src="/todo.jpg" alt="project2" className='w-[200px] lg:w-[300px]' />
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div whileInView={{ opacity: 1, x: 0 }}
                    ...
                    <div className="project flex flex-col justify-center gap-5 m-auto my-5 w-[80%]">
                        ...
                        <div className="flex justify-center items-center">
                            <img src="/user_management_system.jpg" alt="project3" className='w-[200px] lg:w-[300px]' />
                        </div>
                    </div>
                </motion.div>
            </div>
